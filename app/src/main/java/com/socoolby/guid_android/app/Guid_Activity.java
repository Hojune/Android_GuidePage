package com.socoolby.guid_android.app;
...
import com.socoolby.unit.Func;
import com.socoolby.unit.FuncInt;
...
public class Guid_Activity extends Activity implements View.OnClickListener{
    ...
    private Button btn_guid_gotomain;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_guid_gotomain=(Button)findViewById(R.id.btn_guid_gotomain);
...
//                            gotoMain();
    ...
    private synchronized void gotoMain()
    {
        ...
        {
            isGoToMain=true;
            startActivity(new Intent(Guid_Activity.this, MainActivity.class));
            finish();
        }
